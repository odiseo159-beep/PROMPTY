                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="rounded-2xl border border-violet-500/20 bg-gradient-to-b from-violet-500/10 to-transparent p-6 text-center">
                            ...
                            <a href="/sandbox" className="inline-block rounded-xl border border-violet-500/50 px-4 py-2 text-sm font-semibold text-violet-300 hover:bg-violet-500/10 transition-colors w-full">
                                Entrar al Sandbox
                            </a>
                        </div>
                    </div>
